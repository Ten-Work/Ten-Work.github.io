...
この度は、『1A2B 数当てゲーム』、通称『本アプリ』をお気に入りいただき、大変嬉しく思っております。本アプリの各種サービスや情報を安心してご利用いただくために、本アプリのプライバシー保護方針を説明し、お客様の権利利益を保護するため、以下の内容をよくお読みください。

＃＃ プライバシーポリシー

### 1.プライバシー保護ポリシーの適用範囲

サービスの使用時に収集される個人を特定できる情報をこのアプリケーションがどのように扱うかなど、プライバシー保護ポリシーの内容。 本プライバシー保護方針は、本アプリ以外の関連リンクサイトには適用されません。また、本アプリの運営を委託または運営に参加していない者には適用されません。

### 2.個人データの収集、処理、使用

※本アプリケーションのダウンロード、または本アプリケーションが提供する機能サービスをご利用いただく際には、サービスの機能の性質を考慮し、必要な個人情報のご提供をお願いし、特定の目的の範囲内で個人情報を加工・利用させていただきます。 お客様の書面による同意がない限り、このアプリケーションは他の目的で個人データを使用しません。
※本アプリケーションは、サービスメールボックスや会員操作等の機能をご利用いただく際に、お客様が提供していただいたお名前、メールアドレス、連絡先、利用時間などを保持します。
* 一般的なブラウジング中、サーバーは、お客様が使用している接続デバイスの IP アドレス、使用時間、使用しているオペレーティング システム、データの閲覧とクリックなどの関連行動を、当社の参考として自ら記録します。 当社のサービスを向上させるため、この記録は内部使用のため、一般に公開されることはありません。

### 3. データ保護

* このアプリケーション ホストには、ファイアウォール、ウイルス対策システム、その他の関連情報セキュリティ機器が装備されており、Web サイトと個人データを保護するために必要なセキュリティ保護手段が備えられています。 厳格な保護措置を採用し、許可された担当者のみがお客様に連絡することができます 個人データについては、関連する処理担当者が機密保持契約を締結しており、機密保持義務に違反した者は関連する法的制裁の対象となります。
※業務上の必要により他の部門にサービスの提供を委託する必要がある場合には、本申請においても守秘義務の遵守と、それが実際に遵守されていることを確認するために必要な検査手続きの実施を厳格に求めます。

### 4. 外部関連リンク

このアプリケーションが提供するリンクをクリックして他の Web サイトにアクセスすることもできます。 ただし、リンク先のウェブサイトには本アプリケーションのプライバシー保護ポリシーは適用されませんので、リンク先のウェブサイト内のプライバシー保護ポリシーをご参照ください。

### 5.個人データの第三者との共有に関するポリシー

このアプリケーションは、あなたの個人情報を他の個人、グループ、民間企業、または公的機関に提供、交換、貸与、販売することはありませんが、法的根拠や契約上の義務はありません。

前段落のただし書きの状況には、以下が含まれますが、これらに限定されません。

*お客様の書面による同意がある場合。
※法律で明示的に定められているとおりです。
※あなたの生命、身体、自由、財産に対する危険を回避するため。
※公益に基づく統計・学術研究には公的機関や学術研究機関との協力が必要であり、データは提供者によって処理されたり、開示方法からは収集者が特定できないものとなります。
※ウェブサイト上でのお客様の行為が利用規約に違反したり、ウェブサイトや他の利用者の権利利益を害したり阻害したり、第三者に損害を与える可能性がある場合には、ウェブサイト管理部門がお客様の個人情報を特定する目的で調査・開示させていただきます。 連絡するか、法的手段を講じる必要があります。
*あなたの利益を優先します。
※アプリがお客様の個人データの収集、処理、利用をベンダーに委託する場合、アプリは委託先のベンダーまたは個人の監督と管理の責任を負います。

### 6. 一時データの使用

最高のサービスを提供するために、このアプリは会員の信頼証明書やゲーム記録などを含む一時データをデバイスに保存します。 機密データがある場合は、保存前に暗号化されます。

### 7. プライバシー保護ポリシーの修正

このアプリケーションプライバシー保護ポリシーは、要望に応じて随時修正され、修正後の規約はウェブサイトに掲載されます。
...
'1A2B 숫자 야구 게임'(이하 '본 애플리케이션'으로 통칭)을 좋아해주셔서 매우 기쁩니다, 귀하가 안심하고 본 애플리케이션의 다양한 서비스와 정보를 이용할 수 있도록 귀하의 권익을 보호하기 위한 본 애플리케이션의 개인정보 보호정책을 설명합니다.다음 내용을 주의 깊게 읽어보시기 바랍니다.

## 개인 정보 정책

### 1. 개인정보 보호정책의 적용 범위

귀하가 서비스를 사용할 때 수집된 개인 식별 정보를 이 애플리케이션이 처리하는 방법을 포함한 개인정보 보호 정책 내용. 본 개인정보 보호정책은 본 애플리케이션 외부에 링크된 관련 웹사이트에는 적용되지 않으며, 본 애플리케이션의 관리를 위탁하거나 관여하지 않은 자에게는 적용되지 않습니다.

### 2. 개인정보의 수집, 처리 및 활용

* 귀하가 본 애플리케이션을 다운로드하거나 본 애플리케이션이 제공하는 기능적 서비스를 이용하는 경우, 당사는 귀하에게 서비스 기능의 성격에 따라 필요한 개인정보 제공을 요청하고, 해당 목적 범위 내에서 귀하의 개인정보를 처리 및 이용합니다. 이 애플리케이션은 귀하의 서면 동의 없이 개인 데이터를 다른 목적으로 사용하지 않습니다.
* 본 애플리케이션은 귀하가 서비스 사서함, 회원 운영 및 기타 기능을 사용할 때 제공한 이름, 이메일 주소, 연락처, 이용 시간 등을 유지합니다.
* 일반적인 검색 중에 서버는 귀하가 사용하는 연결된 장치의 IP 주소, 사용 시간, 사용된 운영 체제, 검색 및 클릭 데이터 기록 등을 포함하여 관련 동작을 자체적으로 기록하여 당사가 개선할 수 있는 참고 자료로 사용합니다. 이 기록은 내부용으로 절대 대중에게 공개되지 않습니다.

### 3. 데이터 보호

* 본 애플리케이션 호스트는 방화벽, 바이러스 백신 시스템 및 기타 관련 정보 보안 장비와 웹사이트 및 귀하의 개인정보를 보호하기 위해 필요한 보안 조치를 갖추고 있습니다. 엄격한 보호 조치가 채택되어 있습니다. 승인된 담당자만이 귀하에게 접근할 수 있습니다. 모든 관련 개인정보 취급자는 데이터는 기밀 유지 계약을 체결했으며, 기밀 유지 의무를 위반하는 사람은 관련 법적 제재를 받을 수 있습니다.
* 업무상의 필요로 인해 다른 부서에 서비스 제공을 위탁해야 하는 경우, 본 애플리케이션은 해당 기관에도 비밀 유지 의무를 준수하도록 엄격하게 요구하고 실제로 준수하는지 확인하기 위해 필요한 검사 절차를 수행합니다.

### 4. 외부 링크

또한 이 애플리케이션에서 제공하는 링크를 통해 클릭하여 다른 웹사이트에 들어갈 수도 있습니다. 단, 본 어플리케이션에는 링크된 사이트의 개인정보 보호정책이 적용되지 않으므로, 링크된 사이트의 개인정보 보호정책을 반드시 확인하시기 바랍니다.

### 5. 개인정보의 제3자 제공에 관한 방침

본 애플리케이션은 법적 근거나 계약상의 의무가 있는 경우를 제외하고 귀하의 개인정보를 다른 개인, 단체, 민간 기업 또는 공공 기관에 제공, 교환, 임대 또는 판매하지 않습니다.

앞 단락의 단서가 적용되는 상황은 다음을 포함하되 이에 국한되지 않습니다.

*귀하의 서면 동의가 있어야 합니다.
*법률에 명확히 규정되어 있습니다.
* 귀하의 생명, 신체, 자유 또는 재산에 대한 위험을 피하기 위해.
* 공익을 기반으로 한 통계적, 학술적 연구를 위해서는 공공기관이나 학술연구기관과의 협력이 필요하며, 데이터는 제공자에 의해 처리되거나 수집자는 공개되는 방식에 따라 특정 당사자를 식별할 수 없습니다.
* 귀하의 웹사이트에서의 행위가 서비스 약관을 위반하거나, 웹사이트 및 다른 이용자의 권리를 침해 또는 방해하거나 타인에게 피해를 줄 수 있는 경우, 귀하의 개인정보는 웹사이트 관리 부서에서 분석 후 식별 목적으로 공개됩니다. , 연락하거나 법적 조치를 취하는 데 필요한 것.
* 귀하의 권리와 이익에 유익합니다.
* 본 애플리케이션이 제조업체에 귀하의 개인정보 수집, 처리 또는 사용에 대한 지원을 위탁하는 경우, 아웃소싱된 제조업체 또는 개인을 전적으로 감독하고 관리합니다.

### 6. 임시 데이터의 사용

귀하에게 최상의 서비스를 제공하기 위해 이 애플리케이션은 회원 신뢰 인증서 및 게임 기록을 포함하되 이에 국한되지 않는 일부 임시 데이터를 귀하의 장치에 저장합니다. 민감한 데이터가 있는 경우 암호화된 후 저장됩니다.

### 7. 개인정보 보호정책 개정

본 애플리케이션의 개인정보 보호정책은 필요에 따라 수시로 개정되며, 개정된 약관은 웹사이트에 게시됩니다.
